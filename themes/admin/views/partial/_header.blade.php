      ...
      <nav class="navbar navbar-expand-lg px-4 bg-white shadow">
          ...
          <a href="{{ route('home') }}" class="navbar-brand font-weight-bold text-uppercase text-base">
              <img src="{{ asset('images/favicon.png') }}"
                  class="w-12 inline-flex object-center object-contain" />
              {{ config('app.name', 'Rhodaapartmenets') }}</a>
          ...
          <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
              ...
              <li class="nav-item dropdown mr-3">
                  <a id="notifications" href="http://example.com" data-toggle="dropdown" aria-haspopup="true"
                      aria-expanded="false" class="nav-link dropdown-toggle text-gray-400 px-1"><i
                  ...
                  <div aria-labelledby="notifications" class="dropdown-menu">
                      ...
                      <a href="#" class="dropdown-item text-center">
                          <small class="font-weight-bold headings-font-family text-uppercase">View all
                              notifications</small>
                      </a>
                  </div>
              </li>
              ...
              <li class="nav-item dropdown ml-auto">
                  <a id="userInfo" href="http://example.com" data-toggle="dropdown" aria-haspopup="true"
                      aria-expanded="false" class="nav-link dropdown-toggle"><img src="{{ admin()->profile_pic }}" alt="Jason Doe"
