...
@section('content')
    	<section class="py-5">
    	    <div class="mb-4">
    	        ...
    	        <a href="{{ route('admin.guest') }}" class="btn btn-primary float-right rounded"><i class="fas fa-angle-left fa-sm mr-2 text-gray-100"></i> Back</a>
    	        ...
    	        <div class="card-body">
    	            ...
    	            <div class="row">
    	                <div class="col-md-4 mb-5 text-center mt-2">
    	                    <img src="" alt="GuestProfile" class="shadow rounded-circle" style="width: 160px; height: 160px; object-fit:cover;">
    	                </div>
