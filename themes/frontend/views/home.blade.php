...
<head>
    ...
    <style>
       ...
       /* #customers tr:nth-child(even){background-color: #0684fa;} */
...
<body>
    <div class="container lg:p-20 p-10 sm:p-15 mx-auto">
        <div class="">
            ...
            <img src="data:image/png;base64, {{ base64_encode(file_get_contents(public_path('images/favicon.png'))) }}" class="w-32" id="logo" />
        ...
        <div class="mt-12">
            ...
            <hr class="my-6" style="border: 1px solid #0684fa" />
