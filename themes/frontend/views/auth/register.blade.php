...
<section>
    <h3 class="font-bold text-2xl">Book online</h3>
    <p class="text-gray-600 pt-2">Create account.</p>
</section>
    ...
    <form class="flex flex-col" method="POST" action="{{ route('register') }}">
        @csrf
         <div class="mb-6 pt-3 rounded bg-gray-200">
             ...
             <input type="text" id="name" class="@error('name')border-red-500 @enderror bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 px-3 pb-3" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
        ...
        <div class="mb-6 pt-3 rounded bg-gray-200">
          ...
          <div class="mb-6 pt-3 rounded bg-gray-200">
              ...
              <input type="password" id="password" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 px-3 pb-3" name="password_confirmation" required autocomplete="new-password">
